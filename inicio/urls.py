...
from inicio.views import inicio, cargar_vinos, listar_vinos, filtrar_vinos, detalle_vinos, borrar_vinos
...
urlpatterns = [
    ...
    path('borrar-vinos/<int:id>/', borrar_vinos, name="borrar_vinos"),
